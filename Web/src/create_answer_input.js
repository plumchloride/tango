let hiragara = ["あ","い","う","え","お","か","き","く","け","こ","さ","し","す","せ","そ","た","ち","つ","て","と","な","に","ぬ","ね","の","は","ひ","ふ","へ","ほ",
...
$input.addEventListener('input',(e)=>{
  ...
  _anser.forEach(element => {
    if(hiragara.indexOf(element) == -1){
      // カタカナや英語だった場合はそのまま（確定時にテキスト種別を取得する。）
      before_anser.push(element);
    }else{
      // ひらがなをカタカナに
      before_anser.push(katakana[hiragara.indexOf(element)]);
    }
  });
